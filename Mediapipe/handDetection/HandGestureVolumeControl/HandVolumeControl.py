...
import os
# pat=os.getcwd()
# par=os.path.join(pat,os.pardir)
# print(pat)
# print(par)
import sys
...
#         print(length)
        ...
        volBar=np.interp(length,[12,290],[400,150])
        per=np.interp(length,[12,290],[0,100])
#         print(vol)
        volume.SetMasterVolumeLevel(vol, None)
    cv2.rectangle(img,(50,150),(85,400),(0,255,0),3)
    cv2.rectangle(img,(50,int(volBar)),(85,400),(0,255,0),cv2.FILLED)
    cv2.putText(img,str(int(per)),(50,450),cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255),3)
    cTime=time.time()
    fps=1/(cTime-pTime)
    pTime=cTime
